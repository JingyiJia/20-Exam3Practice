...
def run_test_zero_changer():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    test2 = ([8, 4, 3, 9], [0, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 4])
    expected2 = ([8, 4, 1, 9], [1, 2, 3, 1, 5, 4], [4, 5, 4], [4, 6, 4])
    zero_changer(test1)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 4, 3, 9], [9, 9, 8, 1, 5, 0], [4, 0, 4], [0, 0, 4])
    expected3 = ([1, 4, 1, 9], [1, 2, 3, 1, 5, 2], [4, 3, 4], [4, 5, 4])
    zero_changer(test1)
    print()
    print('Test 3:')
